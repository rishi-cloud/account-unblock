const el = {
  ["el-gr"]: {
    ...
    choose_your_signIn_method_continue:
      "Επιλέξτε τη μέθοδο σύνδεσής σας για να συνεχίσετε",
    or: "Ή",
    signIn_with_password: "Συνδεθείτε με κωδικό πρόσβασης",
    one_time_passcode: "Κωδικός μίας χρήσης",
    Sign_in_with_a_onetime_passcode: "Συνδεθείτε με έναν κωδικό μίας χρήσης",
    continue: "Συνέχεια",
    ...
    we_will_send_otp:
      "Θα στείλουμε έναν κωδικό μίας χρήσης στη διεύθυνση ηλεκτρονικού ταχυδρομείου σας για να επαληθεύσουμε την ταυτότητά σας και να σας συνδέσουμε.",
    Sign_in_now: "Σύνδεση τώρα",
    This_passcode_has_expired: "Αυτός ο κωδικός έχει λήξει.",
    Passcode_expires_in: "Ο κωδικός λήγει σε",
    We_will_send_you_a_otp_title:
      "Θα σας στείλουμε έναν κωδικό πρόσβασης μίας χρήσης",
    We_will_send_you_a_otp_subtitle:
      "Εισαγάγετε τη διεύθυνση ηλεκτρονικού ταχυδρομείου σας για να συνεχίσετε.",
    Send_new_code: "Αποστολή νέου κωδικού",
    By_clicking_Create_my_Account_you_accept_McAfee_License_Agreement_and_Privacy_Notice:
      "Κάνοντας κλικ στην επιλογή <b>Δημιουργία λογαριασμού</b> αποδέχεστε τη <a_McAfee_License>Συμφωνία άδειας χρήσης</a_McAfee_License> και τη <a_privacy_notice>Νομική γνωστοποίηση περί απορρήτου</a_privacy_notice> της McAfee.",
    We_are_sorry_but_we_could_not_create_your_account:
      "Λυπούμαστε, αλλά δεν μπορέσαμε να δημιουργήσουμε τον λογαριασμό σας",
    Email_us_at:
      "Στείλτε μας email στο <b>export@mcafee.com</b> εάν έχετε οποιεσδήποτε ερωτήσεις.",
    ...
    LowerCaseCheck: "1 πεζό γράμμα (a-z)",
    NumberCheck: "1 αριθμό (0-9)",
    Length_Check: "{leastcount} έως 32 χαρακτήρες",
    Creating_your_account: "Δημιουργία του λογαριασμού σας...",
