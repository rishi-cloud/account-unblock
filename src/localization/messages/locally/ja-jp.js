const ja = {
  ["ja-jp"]: {
    ...
    choose_your_signIn_method_continue:
      "サインイン方法を選択して続行してください",
    or: "または",
    signIn_with_password: "パスワードでサインインする",
    one_time_passcode: "ワンタイム パスコード",
    Sign_in_with_a_onetime_passcode: "ワンタイム パスコードでサインインする",
    continue: "続行",
    ...
    We_will_send_you_a_otp_title: "ワンタイム パスコードを送信します",
    We_will_send_you_a_otp_subtitle: "メール アドレスを入力して続行します。",
    Send_new_code: "新しいコードを送信する",
    By_clicking_Create_my_Account_you_accept_McAfee_License_Agreement_and_Privacy_Notice:
      "[<b>アカウントの作成</b>] をクリックすると、<a_McAfee_License>マカフィーの使用許諾条件</a_McAfee_License>と<a_privacy_notice>プライバシー通知</a_privacy_notice>に同意したことになります",
    We_are_sorry_but_we_could_not_create_your_account:
      "申し訳ありませんが、アカウントを作成できませんでした",
    Email_us_at:
      "ご不明な点がありましたら、<b>export@mcafee.com</b> までメールをお送りください。",
