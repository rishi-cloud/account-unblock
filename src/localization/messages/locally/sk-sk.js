const sk = {
  ["sk-sk"]: {
    ...
    We_will_send_you_a_otp_title: "Pošleme vám jednorazový prístupový kód",
    ...
    Email_us_at:
      "V prípade otázok pošlite e-mail na adresu <b>export@mcafee.com</b>.",
    Sign_in_with_a_different_email_address:
      "Prihlásiť sa pomocou inej e-mailovej adresy",
    ...
    Length_Check: "{leastcount} až 32 znakov",
    Creating_your_account: "Vytvárame účet...",
