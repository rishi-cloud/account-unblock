          ...
          <div className={styles.SignupWrapper}>
            ...
            {isAffiliateLogo?
                ...
                <span id="n_McafeeLogo" class="container-logo" >
                    <img id="mcafeeLogo" alt="McAfee" title="McAfee" src="https://cdn.jsdelivr.net/gh/atulrana007/McAfee-odrplat-auth0-ui/public/images/McAfee-Document-Logo1.png" class="logo"/>
                </span>
                    <span id="n_AffiliateLogo" class="container-logo aff-logo-container">
                        <span class="logo-seperator">| </span><img id="affiliateLogo" alt="McAfee" title="Dell" src="https://secureimages.mcafee.com/common/affiliateImages/dell/logo_dell_new_58x59.gif" width="20" 
                height="20"/>
                    </span>
            </div>):                
              ...
              {showSignupForm ? (
                !signUpCustomization.hideLoginCTA &&(<div className={styles.BottomHeadingSignUp}>
